...
Real2Render2Real(r2r2r) YuMi 데이터를 GR00T에서 사용하는 LeRobot v2 포맷으로 변환하는 도구입니다.
...
### 4.2 State / Action
- 입력: `robot_data.h5/joint_angles` (T, 16)
...
- action은 **다음 스텝 절대값**으로 저장하고,
  GR00T 설정에서 left/right arm은 **relative**, gripper는 **absolute**로 해석하도록 구성합니다.
...
stats 생성 시에도 NEW_EMBODIMENT 모달리티 설정이 등록되어 있어야 합니다.
...
### NEW_EMBODIMENT 모달리티 설정 예시
GR00T에서 NEW_EMBODIMENT 설정이 필요합니다. 아래 예시는 YuMi용 설정입니다.
